<template>
  ...
  <Icon type="user">用户</Icon>
  <Icon type="refresh" :spin="true">Loading</Icon>
  <Icon type="cog" :spin="true" :danger="true" className="large">设置</Icon>
...
import ModelLogItem from '@/components/page/modelLogs/item.vue'
